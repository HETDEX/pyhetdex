...
def test_fiberfrac(example_ifucen, example_fdither):
    ...
    fiber_map = FiberFracMap(str(example_ifucen), str(example_fdither), psf_type="moffat")
    afrac, afrac2, afluxfrac, afiberfluxfrac, affiberfluxfrac = fiber_map.return_fiberfrac([-11.391], [-9.5263], 1.4)
    bfrac, bfrac2, bfluxfrac, bfiberfluxfrac, bffiberfluxfrac = fiber_map.return_fiberfrac([0.62042], [0.0014127], 1.4)
    cfrac, cfrac2, cfluxfrac, cfiberfluxfrac, cffiberfluxfrac = fiber_map.return_fiberfrac([0.27201], [21.141], 1.4)
